 ...
 */
 ...
 // Função para executar um padrão de LEDs
 void ws2812_run_pattern(PIO pio, uint sm, int pat, int dir, int iterations, int delay_ms) {
     int t = 0;
 ...
 // Função para liberar recursos do PIO
 void ws2812_cleanup(PIO pio, uint sm, uint offset) {
